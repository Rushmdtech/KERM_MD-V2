let {
 ...
 smd(
  ...
  async (message) => {
    const channelMessage = `𝘾𝙃𝘼𝙉𝙉𝙀𝙇 𝙎𝙐𝙋𝙋𝙊𝙍𝙏\n\n _ʜᴇʏ ʜᴇʀᴇ's ᴏᴜʀ ᴄʜᴀɴɴᴇʟ ʟɪɴᴋ, ᴘʟᴇᴀsᴇ ғᴏʟʟᴏᴡ ᴀɴᴅ sᴜᴘᴘᴏʀᴛ ᴜs ᴛᴏ ᴋᴇᴇᴘ ᴛʜɪs ᴘʀᴏᴊᴇᴄᴛ ᴀʟɪᴠᴇ_\n *ʟɪɴᴋ:* https://whatsapp.com/channel/0029VaicAPo2P59qng5LjY0m\n\n ${Config.botname} *©rush Tech*`;
...
smd(
  ...
  async (message) => {
    const SupportMsg = `JOIN WHATSAPP SUPPORT TO FIND SOLUTIONS! \n\n *WHATSAPP SUPPORT :* https://chat.whatsapp.com/DS6iXMBCCgCKlc3Pvaf9rh\n\n ${Config.botname} *WORKS*`;
 ...
 smd({
   ...
   try {
     let _0x12a593 = "*QEEN NITHU BOT IS ACTIVE👋!*";
 ...
 smd({
   ...
   try {
     ...
     if (!_0x587b99) {
       return await _0x4cdec8.reply("*Need URL! Use " + prefix + "ss enter url*");
     }
 ...
 let tmpUrl = "https://telegra.ph/file/8c23f1558601c61e24e46.jpg";
 const secmailData = {};
 smd({
   pattern: "tempmail",
