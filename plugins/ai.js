const {
    ...
    try {
      if (_0xf00650 === _0x242f00(243)) {
        ...
        const _0x3e1043 = await fetch(
          "https://chatgptforprabath-md.vercel.app/api/gptv1",
          {
            method: "POST",
            headers: {
        ...
        if (
          ...
          _0x2d78d9 = "*Invalid ChatGPT API Key, Please Put New*";
        } else {
          _0x2d78d9 =
  ...
  smd({
    ...
    try {
      const res = await (await fetch(`https://chatgptforprabath-md.vercel.app/api/gptv1?q=${text}`)).json();
